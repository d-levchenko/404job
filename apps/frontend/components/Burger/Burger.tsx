...
const Burger = () => {
  ...
  return (
    <section
      className={`max-w-3xl w-full h-full fixed top-0 left-0 -translate-x-full px-5 bg-(--color-scheme-1-background) flex gap-4 flex-col z-9999 transition-transform duration-300 ease-in-out ${
